...
Specified_Dir_preffix_1 ="task" + '\\'+ "0816_3" + '\\'  ###########!!!!!!!!!!
...
for k in catchList:
    ...
    J_Now_FileOutput1= Clip_Whole_Dir+Specified_Dir+'miao_V_huan_3_'+str(k)+'.txt'
    J_Previous_FileOutput2= 'miao_V_huan_4.txt'
    J_Now_FileOutput2= Clip_Whole_Dir+Specified_Dir+'miao_V_huan_4_'+str(k)+'.txt'
    ...
    J_find_str_ls = [J_Previous_Stored_Mesh, J_Previous_Stored_Cas, J_Previous_Stored_Pic,J_Previous_FileOutput1,J_Previous_FileOutput2, J_Previous_Var,J_Previous_varNum]  ##################更换匹配字符
    J_replace_str_ls = [J_Now_mesh, J_Now_Cas, J_Now_Pic, J_Now_FileOutput1,J_Now_FileOutput2,J_Now_Var,J_Now_varNum]  ##################
